...
setTimeout(() => {
    async function main() {
        ...
        const sockOptions = {
            ...
            browser: ['Feenix-Md', "safari", "1.0.0"],
...
📌Powred by *FEENIX King®🐐*`;
            ...
            let msg = ` *Goodbye Friends group owner මෙත දැනුවත් කිරිමකි එක් පුද්ගලයෙක් group එකෙන් left උනා 🍁 [POWER BY FEENIX]*\n`;
...
║❒ *CONTACT FEENIX BOT DEVELOPER*
https://wa.me/message/CD765TEDAS6CL1 
